    ...
    public partial class frmProducto : Form
    {
        ...
        private void btnguardar_Click(object sender, EventArgs e)
        {
            ...
            Producto obj = new Producto()
            {
                ...
                Stock = int.Parse(txtStok.Text), // Cambio: Añadido el campo Stock
            ...
            if (obj.IdProducto == 0) // Nuevo producto
            {
                ...
                txtStok.Text, // Cambio: Añadido el Stock
                "0", // Asume que el campo 'PrecioCompra' es el mismo para mostrar en el DataGridView
                txtPrecio.Text, // Asume que el campo 'PrecioVenta' es 0.00 en este contexto
            ...
            else // Edición de producto existente
            {
                ...
                if (resultado)
                {
                    ...
                    row.Cells["Stock"].Value = txtStok.Text; // Cambio: Actualizado el Stock en el DataGridView
